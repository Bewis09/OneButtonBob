...
public class L6Reverse extends Level {
    public static Rectangle ground1 = new Rectangle(0, 448, 448, 64);
    public static Rectangle ground3 = new Rectangle(448, 448, 320, 64);
    public static Rectangle ground4 = new Rectangle(448, 384, 320, 64);
    ...
    public L6Reverse() {
        super(ground1, ground3, ground4, text);

        ground1.makePassive();
        ground3.makePassive();
        ground4.makePassive();
        ground1.setRepeatingImage("resources/grass.png", new Rectangle2D.Float(0, 32, 64, 64));
        ground3.setRepeatingImage("resources/dirt.png", new Rectangle2D.Float(0, 32, 64, 64));
        ground4.setRepeatingImage("resources/grass.png", new Rectangle2D.Float(32, 32, 64, 64));
    }
    ...
    public void tick(OneButtonBobGame game) {
        if (game.player.getCenterY() > 384 && game.player.getCenterX() > 424) {
